...
#pragma warning( disable : 4701 ) /*  potentially uninitialized local variable 'r' used */
#endif
...
GLT_API void gltDrawText2DFormat(GLTtext *text, GLfloat x, GLfloat y, GLfloat scale, const char* format, ...);
